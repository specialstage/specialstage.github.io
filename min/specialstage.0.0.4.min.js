...
function resize(){var a=300<window.innerWidth&&300<window.innerHeight?2:1;state.SETTINGS&&state.settings(state.STATE);var d=window.innerWidth,t=window.innerHeight;camera.aspect=d/t;camera.updateProjectionMatrix();ui.resize(d,t,a);state.resize(d,t,a)}
