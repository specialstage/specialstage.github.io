...
"",l=K.best[c]-y.CHECKPOINT[c],u=2,w="";return Number.isNaN(l)?void 0===y.CHECKPOINT[c]?(u=4,f+="- 100 sec"):void 0===K.best[c]&&0>K.best[5]?(u=1,f+="+ 100 sec"):void 0===K.best[c]&&(u=1,f+="new time!"):(0<l?(w="+ ",u=1):0>l?(w="- ",u=4):w="+ ",l=Math.abs(l),f+="( "+w+b.time(l)+" )"),b.style=u,f};this.battle=function(){var c=new ib(ra.save(ra.tape),y.MODEL,y.PAINT);Z.push(c);a.reset()};this.replay=function(){if(!y.IMPORT&&!xa){a.STATE=function(){a.replay()};b.clear();Aa?a.nav(a.replay):a.nav(a.results);
uas.AUTOPILOT?a.autopilot():a.drone();var c={};for(c.$jscomp$loop$prop$e$96$158=b.style=0;4>c.$jscomp$loop$prop$e$96$158;c={$jscomp$loop$prop$e$96$158:c.$jscomp$loop$prop$e$96$158},c.$jscomp$loop$prop$e$96$158++){var f="7+"+(4*c.$jscomp$loop$prop$e$96$158).toString(),l=c.$jscomp$loop$prop$e$96$158===uas.CAM-1?48:40;b.button("",f+"-10p","1.0-4+4p","3","4",function(u){return function(){uas.CAM=u.$jscomp$loop$prop$e$96$158+1;a.replay()}}(c),!1);b.sprite(l,64,8,8,f,"1.0-4",8,8)}b.style=0;c=(uas.AUTOPILOT||
...
(uas.POV+1)%3;a.STATE()},!1);Aa||(b.print("<","2","2"),b.button("","2","2+4p","7","8",function(){a.results(a.replay)},!1))};this.drone=function(){b.style=uas.TARGETING?4:2;b.sprite(64,64,8,8,"3","1.0-4",8,8);b.button("","3-10p","1.0-4+4p","3","4",function(){uas.TARGETING=!uas.TARGETING;a.STATE()},!1)};this.next=function(){b.clear();Pa=!0;Ua=Za=Fa=!1;a.PATH=!1;custom_seed="";K.name="";a.BATTLE=[];La=!1;window.history.pushState("","","/");ya.clear();y.REPLAY=!1;y.RESET=!0;y.disconnect();for(var c=0;c<
Z.length;c++)Z[c].disconnect();uas.reset(!0);Z=[];K.SNOW&&da.remove(K.snow.mesh);K.reset();xa=qa=!1;ra.PLAY=!1;a.load();firebase.analytics().logEvent("next_stage")};this.dnf=function(){a.STATE=function(){a.dnf()};b.backdrop(!1);b.clear();a.nav(a.dnf);firebase.analytics().logEvent("dnf");b.print("dnf","0.5-3+3p","0.5-8",2);b.button("restart stage?","2","0.5+8","1.0-4","1.0-4",function(){a.reset("dnf")},!1)};this.reset=function(c){c=void 0===c?"reset":c;Z.index=0;b.clear();a.nav(a.play);xa=!0;qa=!1;
y.reset(!1);for(var f=0;f<Z.length;f++)Z[f].reset();firebase.analytics().logEvent("stage_restart",{status:c})};this.hide=function(c){};this.update=function(){qa||!xa||Ka||(b["delete"](16,16,g-64,16),b["delete"](16,k-32,64,16),b.text(b.time(y.AT()),16,16),b.text(y.SPEED.toString(),16,k-32))};this.loading=function(){for(var c="";c.length<Math.floor(Va/500)%4;)c+=".";qa||(b["delete"](16,16,160,8),b.style=2,b.text("stage generating"+c,16,16),b.style=0);e++};this.scanning=function(){if(0===S.TIMELIST.length&&
ra.SCAN&&!qa){b["delete"](16,72,88,8);for(var c="";c.length<Math.floor(Va/500)%4;)c+=".";b.style=5;b.text("scanning"+c,16,72)}};this.target=function(){b.clear();a.STATE=function(){a.target()};a.nav(a.target);var c,f,l=K.name,u=function(){b.clear();K.SNOW&&da.add(K.snow.mesh);a.STATE=function(){};K.generate.END=!1;a.play();y.SPECTATE=!1;xa=!0;y.connect(K.start,K.surface,!1);a["import"]();firebase.analytics().logEvent("stage_start")};if(Pa||(b.style=2,b.print("stage generated.","2","2"),ra.SCAN?(b.style=
2,b.button("ready (no data)","2","1.0-10","1.0-4","8",function(){u()})):(b.style=0,b.button("ready","2","1.0-10","1.0-4","8",function(){u()}),b.style=4,b.style=1,0<a.BATTLE.length&&b.button("spectate!","1.0-14","1.0-18","12","3",function(){cb=!0;xa=!1;K.generate.END=!1;K.SNOW&&da.add(K.snow.mesh);b.style=0;y.connect(K.start,K.surface);Aa=!0;a["import"]();b.clear();da.add(K.generate.stars);firebase.analytics().logEvent("spectate_start")},!1))),b.style=5,b.print(l,"2","5-1p",2),b.style=0,0!==a.TIMELIST.length||
!ra.SCAN)if(0!==a.TIMELIST.length){var w=a.TIMELIST.slice();for(l=0;l<w.length;l++)for(var O=0;O<w.length;O++)w[l].time<=w[O].time&&w[l].utc<w[O].utc&&l>O&&(c={},Object.assign(c,w[l]),f={},Object.assign(f,w[O]),w[l]=f,w[O]=c);b.style=2;b.print("best time:","2","9");b.style=0;b.print(b.time(w[0].time),"2","12",2);b.style=5;c=(l=w.length<Ya)?w.length:Ya;l=l?0:w.length-Ya;for(f=0;f<c;f++)b.print(f+1+". "+w[f].name,"2","16+"+2*f),b.print(b.time(w[f].time),"18","16+"+2*f);0<l&&b.print("+ "+l+" more entries",
"2",2*c+"+17")}else b.style=2,b.print("no entries found.","2","9"),b.style=0};this.setBattleName=function(){for(var c=0;c<a.BATTLE.length;c++)a.BATTLE[c].name=a.TIMELIST[c].name};this["import"]=function(){a.setBattleName();for(var c={$jscomp$loop$prop$o$105$160:0};c.$jscomp$loop$prop$o$105$160<a.BATTLE.length;c={$jscomp$loop$prop$o$105$160:c.$jscomp$loop$prop$o$105$160},c.$jscomp$loop$prop$o$105$160++)y.IMPORT=!0,ra["import"](K.name+"/"+a.BATTLE[c.$jscomp$loop$prop$o$105$160].uid,function(f){return function(l){a.BATTLE[f.$jscomp$loop$prop$o$105$160].IMPORT_BUFFER=
[];y.INPUTS=[];a.BATTLE[f.$jscomp$loop$prop$o$105$160].data=[];a.BATTLE[f.$jscomp$loop$prop$o$105$160].param={power:l.param.power,drag:l.param.drag,sensitivity:l.param.sensitivity,model:l.param.model,paint:l.param.paint};a.BATTLE[f.$jscomp$loop$prop$o$105$160].cp=l.cp;for(var u=0;u<l.debug.length;u++){var w={time:l.debug[u].time,U:l.debug[u].U,D:l.debug[u].D,L:l.debug[u].L,R:l.debug[u].R};a.BATTLE[f.$jscomp$loop$prop$o$105$160].data.push({U:l.debug[u].U,D:l.debug[u].D,L:l.debug[u].L,R:l.debug[u].R,
time:l.debug[u].time});a.BATTLE[f.$jscomp$loop$prop$o$105$160].IMPORT_BUFFER.push(w)}f.$jscomp$loop$prop$o$105$160===a.BATTLE.length-1&&y["import"]()}}(c))};this.uasComputer=function(){b.clear();b.style=0;var c;b.print("autopilot "+(uas.AUTOPILOT?"enabled":"disabled"),"2","2");uas.AUTOPILOT?(c=S.TIMELIST[uas.data().target].name,b.print("targeting: "+c,"2","4")):(c=0<Z.length?S.TIMELIST[uas.data().target].name:"disabled",b.print("targeting: "+c,"2","4"),b.style=2,c=uas.CTRL||E.SHIFT?"roll":"yaw",b.print("ctrl: "+
...
"2","14");b.print("shift + space    power -","2","16");b.print("ctrl:            roll/yaw toggle","2","18");b.print("r                reset","2","20");b.print("t                targeting mode toggle","2","22");b.print("shift + arrow    change target (targeting)","2","24");b.style=0};this.timelist=function(){b.style=0};this.save=function(){var c=fa+"#"+y.MODEL+"#"+y.PAINT+"#"+y.param().power+y.param().drag+ +y.param().sensitivity+"#"+Date.now();c!==z&&(z=c,a.cSave("SAVE",z))};this.vehicle=function(c){a.STATE=
function(){a.vehicle(c)};qa=!0;b.clear();a.title(function(){c();a.save()},function(){a.menu();sv()});y.REPLAY&&a.reset();var f=[],l=y.param();f.push({id:"power",value:l.power,funct:function(N){y.tune.power(N)}});f.push({id:"drag",value:l.drag,funct:function(N){y.tune.drag(N)}});f.push({id:"sensitivity",value:l.sensitivity,funct:function(N){y.tune.sensitivity(N)}});b.sprite(0,0,1,1,"2","8+-5+3","1.0-2-2",1);b.print("model","2","8+");b.print(y.models()[y.MODEL].name,"2+8","8+");b.sprite(0,0,1,1,"2",
"8++3","1.0-2-2",1);b.button(">","1.0-6","8++4p","4","4",function(){y.MODEL+=1;1<y.MODEL&&(y.MODEL=0);y.body();a.vehicle(c)},!1);b.button("<","1.0-12","8++4p","4","4",function(){--y.MODEL;0>y.MODEL&&(y.MODEL=1);y.body();a.vehicle(c)},!1);b.sprite(0,0,1,1,"2","8+5+-5+3","1.0-2-2",1);b.print("paint","2","8+5+");b.print(rb[y.PAINT],"10","8+5+");b.sprite(0,0,1,1,"2","8+5++3","1.0-2-2",1);b.button(">","1.0-6","8+5++4p","4","4",function(){y.PAINT+=1;y.PAINT>Ia.length-1&&(y.PAINT=0);y.paint();a.vehicle(c)},
!1);b.button("<","1.0-12","8+5++4p","4","4",function(){--y.PAINT;0>y.PAINT&&(y.PAINT=Ia.length-1);y.paint();a.vehicle(c)},!1);for(l={$jscomp$loop$prop$t$107$162:0};l.$jscomp$loop$prop$t$107$162<f.length;l={$jscomp$loop$prop$t$107$162:l.$jscomp$loop$prop$t$107$162},l.$jscomp$loop$prop$t$107$162++){var u="8+5+5+"+(5*l.$jscomp$loop$prop$t$107$162).toString();b.print(f[l.$jscomp$loop$prop$t$107$162].id,"2",u);b.sprite(0,0,1,1,"2",u+"+3","1.0-2-2",1);for(var w={$jscomp$loop$prop$e$108$164:0};6>w.$jscomp$loop$prop$e$108$164;w=
{$jscomp$loop$prop$e$108$164:w.$jscomp$loop$prop$e$108$164},w.$jscomp$loop$prop$e$108$164++){var O="1.0-18+"+(3*w.$jscomp$loop$prop$e$108$164).toString(),P=w.$jscomp$loop$prop$e$108$164<=f[l.$jscomp$loop$prop$t$107$162].value?48:40;b.button("",O+"-10p",u+"+4p","3","4",function(N,ia){return function(){f[N.$jscomp$loop$prop$t$107$162].funct(ia.$jscomp$loop$prop$e$108$164);a.vehicle(c)}}(l,w),!1);b.sprite(P,64,8,8,O,u,8,8)}}};this.scan=function(c,f){};this.settings=function(c){a.STATE=function(){a.settings(c)};
a.SETTINGS=!0;m=Ba+"#"+Ca+"#"+(Ma?1:0)+"#"+(Ra?1:0)+"#";a.cSave("SETTINGS",m);b.clear();h||b.backdrop();a.title(c,a.menu);b.sprite(0,0,1,1,"2","6","1.0-4",1);b.print("ghost config","2","8");b.print("[edit]","1.0-2-6","8");b.button("","2","8+4p","1.0-4","5",function(){a.ghostConfig(c)},!1);b.sprite(0,0,1,1,"2","11","1.0-4",1);$a?(f=Ma?"enabled":"disabled",b.print("display touch hitboxes","2","13"),b.print(f,"1.0-2-"+f.length,"13"),b.sprite(0,0,1,1,"2","21","1.0-4",1),b.button("","2","13+4p","1.0-4",
"5",function(){Ma=!Ma;a.settings(c)},!1)):(b.print("keybindings","2","13"),b.print("arrow / wasdr","1.0-15","13"),b.sprite(0,0,1,1,"2","21","1.0-4",1));b.sprite(0,0,1,1,"2","16","1.0-4",1);b.print("pixel scale","2","18");b.print(""+Da,"1.0-18","18");b.button("+","1.0-6","18+4p","4","4",function(){2>Da&&(Da+=.5);b.style=0;a.settings(c);Ha()},!1);b.button("-","1.0-12","18+4p","4","4",function(){1<Da&&(Da-=.5);b.style=0;a.settings(c);Ha()},!1);b.sprite(0,0,1,1,"2","26","1.0-4",1);b.print("camera mode",
"2","23");var f=y.FPV?"fpv":"tpv";b.print(f,"1.0-6","23");b.button("","2","23+4p","1.0-4","5",function(){y.FPV=!y.FPV;a.settings(c)},!1);b.print("www.procedural.ca","2","1.0-10");b.print("www.ginko.ltd","2","1.0-8");a.discord();b.style=0};this.ghostConfig=function(c,f){a.STATE=function(){a.ghostConfig(c)};var l=Ra?1:0;m=Ba+"#"+Ca+"#"+(Ma?1:0)+"#"+l;a.cSave("SETTINGS",m);b.clear();h||b.backdrop();a.title(c,function(){a.settings(c)});b.sprite(0,0,1,1,"2","6","1.0-4",1);b.print("ghost name","2","8");
b.print(fa,"1.0-13-"+fa.length,"8");b.print("[edit]","1.0-8","8");b.button("","2","9+4p","1.0-4","4",function(){a.inputName(function(){a.ghostConfig(c)},!1)},!1);b.sprite(0,0,1,1,"2","11","1.0-4",1);b.print("ghost limit","2","13");l=Ba.toString();b.print(l,"1.0-13-"+l.length,"13");b.button(">","1.0-6","13+4p","4","4",function(){20>Ba&&(Ba+=1);a.ghostConfig(c)},!1);b.button("<","1.0-12","13+4p","4","4",function(){0<Ba&&--Ba;a.ghostConfig(c)},!1);b.sprite(0,0,1,1,"2","16","1.0-4",1);b.print("ghost priority",
