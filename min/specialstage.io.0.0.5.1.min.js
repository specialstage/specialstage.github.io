...
m.name="Collision Mesh";m.visible=!0;m.material.name="Collision Material";m.material.side=THREE.BackSide;this.checkpoints=[];var A=new THREE.Vector3(0,0,1),F=new THREE.Vector3(1,0,0);new THREE.Vector3(0,1,0);new THREE.Vector3(0,0,1);var Q=new THREE.Vector3(0,3,0),T=new THREE.Vector3(0,0,1),U=w.geometry.clone(),p=x.geometry.clone(),C=z.geometry.clone(),E=t.geometry.clone(),D=[],K=[],ca=new THREE.Vector3;D[0]=new THREE.Vector3(5,3,0);D[1]=new THREE.Vector3(-5,3,0);K[0]=D[0].clone();K.z+=1;K[1]=D[1].clone();
K.z+=1;var O=Math.PI/64,M=Math.PI/32,Y=[],ka=0,ha=new THREE.Vector3;this.start=new THREE.Vector3;var la=!1,ba=!1,Ha=!1;this.IMPORT=this.END=!1;this.DISTANCE=0;var Ia=18,La=new THREE.Raycaster;La.far=800;d.geometry.vertices[0]=Q.clone();d.geometry.vertices[1]=A.clone().add(Q);d.geometry.vertices[2]=D[0].clone();d.geometry.vertices[3]=D[1].clone();d.geometry.vertices[4]=K[0].clone();d.geometry.vertices[5]=K[1].clone();this.connect=function(){scope.SEED=Oa;g=scope.randomInt(0,3);N.SNOW=2===g;N.SNOW&&
N.snow.init();aa.add(d);aa.add(w);aa.add(z);aa.add(t);aa.add(x);aa.add(wireframe);aa.add(l);ka=window.performance.now();window.setTimeout(scope.generate,0)};this.disconnect=function(){for(var k in Y=[],aa.remove(d),aa.remove(w),aa.remove(z),aa.remove(t),aa.remove(x),aa.remove(wireframe),aa.remove(l),aa.remove(c),e)e[k].flag=[];for(var h in scope.checkpoints)aa.remove(scope.checkpoints[h].display),scope.checkpoints[h].display.geometry.dispose(),scope.checkpoints[h].collision.geometry.dispose()};this.complete=
...
N.surface=m.clone();N.start=scope.start.clone();ka=window.performance.now()-ka;la=!0;scope.END=!0;firebase.analytics().logEvent("stage_generation_complete",{time:Math.round(ka/1E3)});cb?(b.clear(),G.connect(N.start,N.surface),G.PLAY=!1,da.PLAY=!0):na.ready()};this.reset=function(){Ia=(36+scope.random()-.5)/2;a=0;w.geometry.dispose();z.geometry.dispose();x.geometry.dispose();d.geometry.dispose();t.geometry.dispose();r.geometry.dispose();wireframe.geometry.dispose();m.geometry.dispose();c.geometry.dispose();
...
3,0);la&&(la=!1,ba=!1,Ha=!1);this.END=!1;d.position.set(0,0,0);d.geometry.vertices[0]=Q.clone();d.geometry.vertices[1]=A.clone().add(Q);d.geometry.vertices[2]=D[0].clone();d.geometry.vertices[3]=D[1].clone();d.geometry.vertices[4]=K[0].clone();d.geometry.vertices[5]=K[1].clone();d.geometry.verticesNeedUpdate=!0};this.generate=function(){scope.path()};this.path=function(k,h,f,y,u,q,S,B,I,H){k=void 0===k?0:k;h=void 0===h?0:h;f=void 0===f?0:f;y=void 0===y?0:y;u=void 0===u?0:u;q=void 0===q?{start:0,end:30,
angle:0,slope:0}:q;S=void 0===S?[]:S;B=void 0===B?[]:B;I=void 0===I?!1:I;H=void 0===H?999:H;var P=window.performance.now(),Z=0;for(0===y&&(y=.5<scope.random()?1:-1);32>Z&&!ba;){if(k===q.end+1){B=[];for(f=0;1>f;f++)if(k>=scope.length)B.push({angle:0,slope:0,end:30}),H=k+30;else if(0===h){var V=scope.randomInt(2,4)*y;Z=Math.floor(Math.abs(36/V));y=.01>scope.random()?+y:-1*y;Z=scope.randomInt(1,Z);B.push({angle:V,slope:0,end:Z})}else V=scope.randomInt(-5,-1),Z=scope.random(),V=2!==g&&.05>Z?V*=-1:V,Z=
scope.randomInt(2,20),B.push({angle:0,slope:V,end:Z});Z=scope.randomInt(0,B.length);h=B[Z].angle;f=B[Z].slope;q.start=k;q.end=k+B[Z].end;B=B.slice(Z,1)}if(I||(scope.extrude(h,f),Y.push({angle:h,slope:f}),U.verticesNeedUpdate=!0,k++),10<=k&&!I){Z=new THREE.Vector2(U.vertices[k-1].x,U.vertices[k-1].y);for(V=0;V<U.vertices.length-1-10;V++)if(18>(new THREE.Vector2(U.vertices[V].x,U.vertices[V].y)).distanceTo(Z)){I=!0;break}I&&window.setTimeout(N.reset(!0),0)}0;k===H&&(ba=!0,w.geometry.dispose(),w.geometry=
U.clone(),w.geometry.computeBoundingSphere(),w.geometry.center(),w.updateMatrixWorld(),0<w.geometry.vertices.length&&(ha.copy(w.geometry.vertices[0]),ha.sub(U.vertices[0])),window.setTimeout(function(){na.PATH=!0;na.STATE();scope["import"]()},0));Z=window.performance.now()-P}ba||I||window.setTimeout(scope.path,0,k,h,f,y,u,q,S,B,I,H)};this.skijump=function(k,h,f,y,u,q,S,B,I,H,P){k=void 0===k?0:k;h=void 0===h?0:h;f=void 0===f?0:f;y=void 0===y?0:y;u=void 0===u?0:u;q=void 0===q?{start:0,end:20,angle:0,
slope:0}:q;S=void 0===S?[]:S;B=void 0===B?[]:B;I=void 0===I?!1:I;H=void 0===H?300:H;P=void 0===P?0:P;var Z=window.performance.now(),V=0;for(0===y&&(y=.5<scope.random()?1:-1);32>V&&!ba;){if(k===q.end+1){B=[];for(h=0;1>h;h++)0===f&&20===q.end?(P=-1,B.push({angle:0,slope:-4,end:30})):3===f?B.push({angle:0,slope:4,end:3}):4===f?B.push({angle:0,slope:-32,end:10}):-4===f?(P=1,B.push({angle:0,slope:f+1,end:1})):-32===f?B.push({angle:0,slope:-4,end:40}):1==P?B.push({angle:0,slope:f+1,end:1}):-1==P&&B.push({angle:0,
slope:f-1,end:1});V=scope.randomInt(0,B.length);h=B[V].angle;f=B[V].slope;q.start=k;q.end=k+B[V].end;B=B.slice(V,1)}if(I||(scope.extrude(h,f),Y.push({angle:h,slope:f}),U.verticesNeedUpdate=!0,k++),10<=k&&!I){V=new THREE.Vector2(U.vertices[k-1].x,U.vertices[k-1].y);for(var ua=0;ua<U.vertices.length-1-10;ua++)if(0>(new THREE.Vector2(U.vertices[ua].x,U.vertices[ua].y)).distanceTo(V)){I=!0;break}I&&window.setTimeout(N.reset(!0),0)}0;H<=k&&(ba=!0,w.geometry.dispose(),w.geometry=U.clone(),w.geometry.computeBoundingSphere(),
w.geometry.center(),w.updateMatrixWorld(),0<w.geometry.vertices.length&&(ha.copy(w.geometry.vertices[0]),ha.sub(U.vertices[0])),window.setTimeout(function(){scope["import"]()},0));V=window.performance.now()-Z}ba||I||window.setTimeout(scope.skijump,0,k,h,f,y,u,q,S,B,I,H)};this["import"]=function(k){k=void 0===k?0:k;for(var h=window.performance.now(),f=0;!Ha&&32>f;){if(0===k&&(d.position.set(0,0,0),d.rotation.z=0,Q.set(0,3,0),d.geometry.vertices[0]=Q.clone(),d.geometry.vertices[1]=A.clone().add(Q),
d.geometry.vertices[2]=D[0].clone(),d.geometry.vertices[3]=D[1].clone(),d.geometry.vertices[4]=K[0].clone(),d.geometry.vertices[5]=K[1].clone(),d.geometry.verticesNeedUpdate=!0,d.updateMatrixWorld()),k<Y.length)a=k,angle=Y[k].angle,slope=Y[k].slope,scope.extrude(angle,slope),z.geometry.dispose(),z.geometry=C.clone(),z.geometry.computeBoundingSphere(),t.geometry.dispose(),t.geometry=E.clone(),t.geometry.computeBoundingSphere(),x.geometry.dispose(),x.geometry=p.clone(),x.geometry.computeBoundingSphere(),
k++;else if(!Ha&&k===Y.length){for(var y in scope.checkpoints=scope.checkpoint(),scope.checkpoints)aa.add(scope.checkpoints[y].display);Ha=!0;window.setTimeout(function(){scope.terrain(!0)},0)}f=window.performance.now()-h}Ha||window.setTimeout(scope["import"],0,k,angle,slope)};this.extrude=function(k,h){k=void 0===k?0:k;h=void 0===h?0:h;for(var f in d.updateMatrixWorld(),d.rotateZ(k*M),d.geometry.vertices)d.geometry.vertices[f].applyAxisAngle(F,h*O);d.geometry.verticesNeedUpdate=!0;f=d.geometry.vertices[0].clone();
var y=d.geometry.vertices[2].clone(),u=d.geometry.vertices[3].clone(),q=d.geometry.vertices[1].clone();if(f.applyMatrix4(d.matrix),y.applyMatrix4(d.matrix),u.applyMatrix4(d.matrix),q.applyMatrix4(d.matrix),q.sub(f),ba){if(y.add(ha),u.add(ha),0<C.vertices.length){var S=C.vertices[C.vertices.length-1].clone().sub(ca),B=C.vertices[C.vertices.length-2].clone().sub(ca);p.vertices.push(y.clone().sub(q));p.vertices.push(u.clone().sub(q));p.vertices.push(B);p.vertices.push(u.clone().sub(q));p.vertices.push(S);
...
0,1);k.vertices.push(q);k.vertices.push(S);k.colors.push(X[2]);k.colors.push(X[2]);f.push({v:S.clone(),n:S.clone(),pitch:H.clone(),roll:P.clone()});for(q=[];4>I;){S=[];for(H=0;H<f.length;H++)for(var Z=P=0;3>Z;Z++){var V=0===I&&2===Z&&1>P?1:scope.random();if(.2<V){V=scope.randomInt(-2,2);var ua=f[H].n.clone(),za=X[2];ua.applyAxisAngle(f[H].pitch,2*Math.PI/(B+V));ua.applyAxisAngle(f[H].roll,2*Math.PI/3*Z);ua.multiplyScalar(y);V=ua.clone().add(f[H].v);k.vertices.push(f[H].v.clone());k.vertices.push(V);
k.colors.push(za);k.colors.push(za);za=f[H].pitch.clone();za.applyAxisAngle(f[H].roll,2*Math.PI/3*Z);za.applyAxisAngle(f[H].pitch,2*Math.PI/B);var va=f[H].roll.clone();va.applyAxisAngle(f[H].pitch,2*Math.PI/B);va.applyAxisAngle(f[H].roll,2*Math.PI/3*Z);0<Z&&h.push({a:V.clone(),b:f[H].v.clone(),pitch:za,roll:va});S.push({v:V.clone(),n:ua.clone(),pitch:za,roll:va});P++}else 0===P&&2===Z&&q.push({v:f[H].v.clone(),n:f[H].n.clone(),pitch:f[H].pitch.clone(),roll:f[H].roll.clone()})}f=S.slice();y*=.9;I++}for(u in B=
...
4*f/2*3;scope.start.copy(h.vertices[36]);scope.start.sub(h.vertices[37]);scope.start.multiplyScalar(-.75);scope.start.add(h.vertices[36]);for(h=0;5>h;h++)null==N.best&&(N.best[h]=4>h?f*(h+1)/Ia:N.best[h]=N.best[h-1]);return na.STATE(),y};this.resetCheckpoints=function(){for(var k in scope.checkpoints)scope.checkpoints[k].display.material.color=X[5]};this.random=function(){Oa=(Oa+1)%2147483647;var k=1E4*Math.sin(Oa);return k-Math.floor(k)};this.randomInt=function(k,h){return Math.floor(scope.random()*
...
!0;a.snow.mesh.geometry.computeBoundingSphere()}};for(var e=0;4>e;e++)this.checkpoint[this.checkpoint.length]=new THREE.Mesh(new THREE.Geometry);this.connect=function(g){g=void 0===g?!1:g;if(W.position.set(0,400,200),W.far=2E3,W.updateProjectionMatrix(),W.lookAt(new THREE.Vector3),wa.render(aa,W),!g){this.name=this.generate.name();g="";for(var d in this.name)g+=this.name.charCodeAt(d).toString();Oa=g}a.generate.connect();sb++};this.disconnect=function(){this.generate.disconnect();this.generate.reset()};
this.reset=function(g){g=void 0===g?!1:g;Oa++;a.COMPLETE=!1;a.disconnect();a.generate=new ib;a.connect(g)};this.preview=function(){window.setTimeout(0,0)};this.update=function(){this.SNOW&&this.snow.update()}}function tb(){var a=this,e,g,d="",w=0,z=0;this.custom_seed="";var x="#1#ffffff#334#",t=Ba+"#1#",r=!0;this.SETTINGS=!1;this.STATE=function(){a.intro()};this.CHALLENGES={};this.CHALLENGER="";this.TIMELIST=[];this.BATTLE=[];this.PATH=!1;this.login=function(){firebase.auth().onAuthStateChanged(function(c){return c?
(oa=c.uid,a.STATE(),da.requestName(oa,function(l){ea=l;a.STATE()})):(oa=!1,a.STATE()),null})};this.register=function(c){b.clear();a.STATE=function(){a.register(c)};fb=!0;a.inputName(function(){fb=!1;da["export"]()},!0,"input name to save data")};this.resize=function(c,l){e=b.width;g=b.height;a.STATE();$a=Math.floor((window.innerHeight/b.scale/b.row-34)/2)};this.wallet=function(){var c=G.yen();b.print("$ "+c.toString(),"2","1.0-4")};this.nav=function(c){c=void 0===c?function(){b.clear()}:c;b.sprite(8,
64,8,8,"1.0-4+2p","2",8,8);b.button("","1.0-8","2+4p","8","8",function(){a.menu(c)},!1)};this.title=function(c,l){a.breadcrumb(c,l);b.sprite(16,64,8,8,"1.0-4+2p","2",8,8);b.button("","1.0-7","2+4p","7","5",function(){r||b.backdrop(!1);c();ra=!1;a.SETTINGS=!1},!1);a.wallet()};this.breadcrumb=function(c,l){l=void 0===l?function(){r||b.backdrop(!1);c();ra=!1;a.SETTINGS=!1}:function(){a.menu(c);ra=!0};b.print("< menu","2","2");b.button("","2","2+4p","7","8",l,!1)};this.menu=function(c){ra=!0;a.STATE=
function(){a.menu(c)};r||b.backdrop();b.clear();a.title(c);b.sprite(0,0,1,1,"2","6","1.0-4",1);b.print(" > modify vehicle","2","8");b.button("","2","8+4p","1.0-4","5",function(){a.vehicle(c)},!1);b.sprite(0,0,1,1,"2","11","1.0-4",1);b.print(" > settings","2","13");b.button("","2","13+4p","1.0-4","5",function(){a.settings(c)},!1);b.sprite(0,0,1,1,"2","16","1.0-4",1);var l=8;(Ga||da.PLAY)&&(b.button("restart stage","2","1.0-2-"+l,"1.0-4","6",function(){b.backdrop(!1);a.reset()},!0),l+=8);N.COMPLETE&&
(Ga||da.PLAY)&&b.button("next stage","2","1.0-2-"+l,"1.0-4","6",function(){b.backdrop(!1);a.next()},!0);a.discord()};this.intro=function(){var c;a.STATE=function(){a.intro()};r=!0;b.clear();b.print("specialstage.io","2","2");b.print("-","2","4");b.link("","0","1.0-24","26","6","https://ginko.ltd");b.print("new physical items","2","1.0-23");b.print("available at","2","1.0-21");b.style=1;b.print("ginko.ltd","2+13","1.0-21");b.style=0;Ja?(b.style=4,b.print("challenge detected!","2","12"),b.style=0,c=
null!==a.CHALLENGER&&0<a.CHALLENGER.length?a.CHALLENGER:"...",b.style=2,b.print("rival:","2","15"),b.style=0,b.print(c,"9","15"),da.requestName(a.CHALLENGES.uid,function(l){a.CHALLENGER=l;a.STATE()}),b.style=2,b.print("seed:","2","17"),b.style=0,b.print(a.CHALLENGES.seed,"9","17")):Sa&&(b.style=3,b.print("seed detected","2","13",1),b.style=0,b.print("> "+a.custom_seed,"2","16",1));null!==oa&&!1===oa||""!==ea?""!==ea?(b.style=5,b.print("welcome back!","2","6"),b.style=0,b.print("> "+ea,"2","9"),b.style=
2,b.print("[edit]",ea.length+"+5","9"),b.style=0,b.button("","2","9+4p",ea.length+"+9","4",function(){a.inputName(a.intro)},!1)):!1===oa&&""===ea&&(b.style=2,b.print("user data not detected","2","6"),b.style=0,b.print("> [register/sign in]","2","9"),b.button("","2","9+4p","1.0-4","4",function(){a.inputName(a.intro)},!1)):(b.style=2,b.print("> loading user data...","2","6"),b.style=0);b.style=2;b.print("0.0.5.1","2","1.0-4");b.style=0;a.nav(function(){a.intro()});b.print("menu","1.0-9","2");b.button("",
...
"1.0-5","12","4","https://discord.gg/ACewNWH");b.style=0};this.load=function(){a.STATE=function(){a.target()};a.TIMELIST=[];da.scan(N.name,function(c){for(var l={$jscomp$loop$prop$t$82$146:0};l.$jscomp$loop$prop$t$82$146<c.length;l={$jscomp$loop$prop$t$82$146:l.$jscomp$loop$prop$t$82$146},l.$jscomp$loop$prop$t$82$146++)a.TIMELIST[l.$jscomp$loop$prop$t$82$146]={uid:c[l.$jscomp$loop$prop$t$82$146].uid,time:c[l.$jscomp$loop$prop$t$82$146].time,name:"..."},da.requestName(c[l.$jscomp$loop$prop$t$82$146].uid,
function(A){return function(F){a.TIMELIST[A.$jscomp$loop$prop$t$82$146].name=F;a.STATE()}}(l)),da.checkTime(oa,c[l.$jscomp$loop$prop$t$82$146].uid,c[l.$jscomp$loop$prop$t$82$146].time);var n=a.TIMELIST.length<Ba?a.TIMELIST.length:Ba;l=[];switch(Ca){case 0:l=c.slice(0,n);break;case 1:for(c=c.slice();l.length<n;){var m=Math.floor(Math.random()*c.length);l.push(Object.assign({},c[m]));c.splice(m,1)}}if(a.BATTLE=l.slice(),Ga)for(n=0;n<l.length;n++)da["import"](N.name+"/"+l[n].uid,function(A){pa.push(new gb(A.tape,
A.model,A.paint,A.cp))});a.STATE()});Ta=!0;a.target();w=0};this.ready=function(){Ta=!1;a.STATE()};this.play=function(){b.clear();a.nav(a.play);ra=!1};this.complete=function(){ra=!0;b.clear();a.nav(a.complete);var c="stage complete!";b.style=0;b.print(c,"0.5-"+2*Math.round(c.length/2),"0.3-1",2);b.style=0;N.COMPLETE=!0;window.setTimeout(function(){!1===oa||null===oa?(a.register(),a.STATE=function(){a.results()}):(a.STATE=function(){a.results()},da["export"](a.results))},2E3);c=G.param().model+" ("+
(G.param().power+1)+"/"+(G.param().drag+1)+"/"+(G.param().sensitivity+1)+"/"+(G.param().ease+1)+")";firebase.analytics().logEvent("stage_complete",{operator_id:ea,time:G.AT(),penalty:G.PENALTY(),score:G.AT()+G.PENALTY(),seed:N.name,rating:Math.round(N.generate.DISTANCE/(G.AT()+G.PENALTY())),distance:N.generate.DISTANCE,vehicle:c})};this.results=function(){a.STATE=function(){a.results()};b.clear();ea;da.tape.slice();ra=!0;var c,l=b["float"](G.AT()+G.PENALTY()),n=0;if(0<a.TIMELIST.length){for(var m=
Math.floor(100*(G.AT()+G.PENALTY()))/100,A=0;A<a.TIMELIST.length;A++)if(m<a.TIMELIST[A].time){n=A+1;break}0==n&&(n=a.TIMELIST.length+1)}a.nav(a.results);b.style=5;b.print("stage complete! "+N.name,"2","2");b.style=0;b.print(l,"2","5",2);0!=n?b.print("rank "+n,2*l.length+"+3".toString(),"5+4p"):G.AT()+G.PENALTY()<N.best[4]?(c=Ja?"challenge victory!":"new record!",b.style=4,b.print(c,2*l.length+"+3".toString(),"5+4p"),b.style=0):Ja&&b.print("challenge failed",2*l.length+"+3".toString(),"5+4p");c=9;
l=G.CP();if(320<g){for(m=0;m<l.length-1;m++){b.style=5;b.print("cp "+(m+1).toString(),"2",c+"+"+m.toString());m;var F=void 0;A=void 0;A="number"==typeof l[m]?(F=b["float"](l[m]),Number.isNaN(N.best[m])?"+1 cp":l[m]-N.best[m]):(F="penalty",b.style=4,"");b.print(F.toString(),"0.5 -1-"+F.length.toString(),c+"+"+m.toString());b.style=0;F="penalty"===F?"25 sec":"+1 cp"==A?"+1 cp":0<A?"( - "+b["float"](A)+" )":"( + "+b["float"](Math.abs(A))+" )";b.style=0<A?4:0>A?1:0===A?2:4;b.print(F,"0.5+1",c+"+"+m.toString());
b.style=0;c+=1}c+=5}1===n&&(b.style=1,b.print("new record!","2",c.toString(),2),b.style=0);b.button("issue challenge","0.5+1","1.0-20","0.5-3","4",a.challenge);b.button("modify vehicle","2","1.0-20","0.5-3","4",function(){b.backdrop();a.vehicle(a.results)});b.button("next stage","2","1.0-12","1.0-4","8",function(){a.next()});b.button("restart stage","2","1.0-4","0.5-3","4",function(){a.reset("complete")});b.button("view replay","0.5+1","1.0-4","0.5-3","4",function(){a.replay()});window.setTimeout(function(){Ga=
!1;da.PLAY=!0},0)};this.battle=function(){var c=new gb(da.save(da.tape),G.MODEL,G.PAINT);pa.push(c);a.reset()};this.replay=function(){a.STATE=function(){a.results()};b.clear();a.nav(a.results);for(var c={$jscomp$loop$prop$e$89$148:0};4>c.$jscomp$loop$prop$e$89$148;c={$jscomp$loop$prop$e$89$148:c.$jscomp$loop$prop$e$89$148},c.$jscomp$loop$prop$e$89$148++){var l="4+"+(4*c.$jscomp$loop$prop$e$89$148).toString(),n=c.$jscomp$loop$prop$e$89$148===G.CAMERA-1?48:40;b.button("",l+"-10p","1.0-4+4p","3","4",
function(m){return function(){G.CAMERA=m.$jscomp$loop$prop$e$89$148+1;a.replay()}}(c),!1);b.sprite(n,64,8,8,l,"1.0-4",8,8)}b.print("<","2","2");b.button("","2","2+4p","7","8",function(){a.results(a.replay)},!1)};this.next=function(){b.clear();Ta=!0;Sa=cb=Ja=!1;a.PATH=!1;custom_seed="";N.name="";a.BATTLE=[];Ua=!1;window.history.pushState("","","/");wa.clear();G.reset();G.disconnect();for(var c=0;c<pa.length;c++)pa[c].disconnect();pa=[];N.SNOW&&aa.remove(N.snow.mesh);N.reset();Ga=ra=!1;da.PLAY=!1;a.load();
firebase.analytics().logEvent("next_stage")};this.dnf=function(){a.STATE=function(){a.dnf()};b.backdrop(!1);b.clear();a.nav(a.dnf);firebase.analytics().logEvent("dnf");b.print("dnf","0.5-3+3p","0.5-8",2);b.button("restart stage?","2","0.5+8","1.0-4","1.0-4",function(){a.reset("dnf")},!1)};this.reset=function(c){c=void 0===c?"reset":c;pa.index=0;b.clear();a.nav(a.play);Ga=!0;ra=!1;G.reset();for(var l=0;l<pa.length;l++)pa[l].reset();firebase.analytics().logEvent("stage_restart",{status:c})};this.update=
function(){ra||!Ga||Ma||(b["delete"](16,16,e-64,16),b["delete"](16,g-32,64,16),b.text(b["float"](G.AT()),16,16),b.text(G.SPEED.toString(),16,g-32))};this.loading=function(){d=0!=w%16?d:3<=d.length?"":d+".";ra||(b["delete"](16,16,160,8),b.style=2,b.text("stage generating"+d,16,16),b.style=0);w++};this.target=function(){b.clear();a.STATE=function(){a.target()};a.nav(a.target);var c=N.name;if(Ta||(b.style=2,b.print("stage generated.","2","2"),b.style=0,b.button("ready","2","1.0-10","1.0-4","8",function(){for(var m=
0;m<a.BATTLE.length;m++)da["import"](N.name+"/"+a.BATTLE[m].uid,function(A){pa.push(new gb(A.tape,A.model,A.paint,A.cp))});a.STATE=function(){};N.generate.END=!1;b.clear();a.play();Ga=!0;G.connect(N.start,N.surface,!1);firebase.analytics().logEvent("stage_start")})),b.style=5,b.print(c,"2","5-1p",2),(b.style=0)===a.TIMELIST.length&&da.SCAN)b.style=5,b.print("scanning...","2","9");else if(0!==a.TIMELIST.length){b.style=2;b.print("best time:","2","9");b.style=0;b.print(b["float"](a.TIMELIST[0].time),
"2","12",2);b.style=5;var l=(c=a.TIMELIST.length<$a)?a.TIMELIST.length:$a;c=c?0:a.TIMELIST.length-$a;for(var n=0;n<l;n++)b.print(n+1+". "+a.TIMELIST[n].name,"2","16+"+2*n),b.print(b["float"](a.TIMELIST[n].time),"18","16+"+2*n);0<c&&b.print("+ "+c+" more entries","2",2*l+"+17")}else b.style=2,b.print("no entries found.","2","9"),b.style=0};this.save=function(){var c=ea+"#"+G.MODEL+"#"+G.PAINT+"#"+G.param().power+G.param().drag+ +G.param().sensitivity+"#"+Date.now();c!==x&&(x=c,a.cSave("SAVE",x))};
this.vehicle=function(c){a.STATE=function(){a.vehicle(c)};ra=!0;b.clear();a.title(function(){c();a.save()},function(){a.menu();sv()});var l=[],n=G.param();l.push({id:"power",value:n.power,funct:function(T){G.tune.power(T)}});l.push({id:"drag",value:n.drag,funct:function(T){G.tune.drag(T)}});l.push({id:"sensitivity",value:n.sensitivity,funct:function(T){G.tune.sensitivity(T)}});b.sprite(0,0,1,1,"2","8+-5+3","1.0-2-2",1);b.print("model","2","8+");b.print(G.models()[G.MODEL].name,"2+8","8+");b.sprite(0,
0,1,1,"2","8++3","1.0-2-2",1);b.button(">","1.0-6","8++4p","4","4",function(){G.MODEL+=1;1<G.MODEL&&(G.MODEL=0);G.body();a.vehicle(c)},!1);b.button("<","1.0-12","8++4p","4","4",function(){--G.MODEL;0>G.MODEL&&(G.MODEL=1);G.body();a.vehicle(c)},!1);b.sprite(0,0,1,1,"2","8+5+-5+3","1.0-2-2",1);b.print("paint","2","8+5+");b.print(ub[G.PAINT],"10","8+5+");b.sprite(0,0,1,1,"2","8+5++3","1.0-2-2",1);b.button(">","1.0-6","8+5++4p","4","4",function(){G.PAINT+=1;G.PAINT>Va.length-1&&(G.PAINT=0);G.paint();
a.vehicle(c)},!1);b.button("<","1.0-12","8+5++4p","4","4",function(){--G.PAINT;0>G.PAINT&&(G.PAINT=Va.length-1);G.paint();a.vehicle(c)},!1);for(n={$jscomp$loop$prop$t$94$150:0};n.$jscomp$loop$prop$t$94$150<l.length;n={$jscomp$loop$prop$t$94$150:n.$jscomp$loop$prop$t$94$150},n.$jscomp$loop$prop$t$94$150++){var m="8+5+5+"+(5*n.$jscomp$loop$prop$t$94$150).toString();b.print(l[n.$jscomp$loop$prop$t$94$150].id,"2",m);b.sprite(0,0,1,1,"2",m+"+3","1.0-2-2",1);for(var A={$jscomp$loop$prop$e$95$152:0};6>A.$jscomp$loop$prop$e$95$152;A=
{$jscomp$loop$prop$e$95$152:A.$jscomp$loop$prop$e$95$152},A.$jscomp$loop$prop$e$95$152++){var F="1.0-18+"+(3*A.$jscomp$loop$prop$e$95$152).toString(),Q=A.$jscomp$loop$prop$e$95$152<=l[n.$jscomp$loop$prop$t$94$150].value?48:40;b.button("",F+"-10p",m+"+4p","3","4",function(T,U){return function(){l[T.$jscomp$loop$prop$t$94$150].funct(U.$jscomp$loop$prop$e$95$152);a.vehicle(c)}}(n,A),!1);b.sprite(Q,64,8,8,F,m,8,8)}}};this.settings=function(c){a.STATE=function(){a.settings(c)};a.SETTINGS=!0;t=Ba+"#"+Ca+
"#"+(Na?1:0)+"#";a.cSave("SETTINGS",t);b.clear();r||b.backdrop();a.title(c,a.menu);b.sprite(0,0,1,1,"2","6","1.0-4",1);b.print("ghost config","2","8");b.print("[edit]","1.0-2-6","8");b.button("","2","8+4p","1.0-4","5",function(){a.ghostConfig(c)},!1);b.sprite(0,0,1,1,"2","11","1.0-4",1);db?(l=Na?"enabled":"disabled",b.print("display touch hitboxes","2","13"),b.print(l,"1.0-2-"+l.length,"13"),b.sprite(0,0,1,1,"2","21","1.0-4",1),b.button("","2","13+4p","1.0-4","5",function(){Na=!Na;a.settings(c)},
!1)):(b.print("keybindings","2","13"),b.print("arrow / wasdr","1.0-15","13"),b.sprite(0,0,1,1,"2","21","1.0-4",1));b.sprite(0,0,1,1,"2","16","1.0-4",1);b.print("camera mode","2","18");var l=G.FPV?"fpv":"tpv";b.print(l,"1.0-6","18");b.button("","2","18+4p","1.0-4","5",function(){G.FPV=!G.FPV;a.settings(c)},!1);b.print("www.procedural.ca","2","1.0-10");b.print("www.ginko.ltd","2","1.0-8");a.discord()};this.ghostConfig=function(c,l){l=void 0===l?!1:l;a.STATE=function(){a.ghostConfig(c)};var n=Na?1:0;
t=Ba+"#"+Ca+"#"+n+"#";a.cSave("SETTINGS",t);b.clear();r||b.backdrop();a.title(c,function(){a.settings(c)});b.sprite(0,0,1,1,"2","6","1.0-4",1);b.print("ghost name","2","8");b.print(ea,"1.0-13-"+ea.length,"8");b.print("[edit]","1.0-8","8");b.button("","2","9+4p","1.0-4","4",function(){a.inputName(function(){a.ghostConfig(c)},!1)},!1);b.sprite(0,0,1,1,"2","11","1.0-4",1);b.print("ghost limit","2","13");n=Ba.toString();b.print(n,"1.0-13-"+n.length,"13");b.button(">","1.0-6","13+4p","4","4",function(){20>
Ba&&(Ba+=1);a.ghostConfig(c)},!1);b.button("<","1.0-12","13+4p","4","4",function(){0<Ba&&--Ba;a.ghostConfig(c)},!1);b.sprite(0,0,1,1,"2","16","1.0-4",1);b.print("ghost priority","2","18");n=0===Ca?"best":"random";b.print(n,"1.0-13-"+n.length,"18");b.button(">","1.0-6","18+4p","4","4",function(){Ca+=1;1<Ca&&(Ca=0);a.STATE()},!1);b.button("<","1.0-12","18+4p","4","4",function(){--Ca;0>Ca&&(Ca=1);a.STATE()},!1);b.sprite(0,0,1,1,"2","21","1.0-4",1);l&&b.print("* changes require stage generation","2",
"1.0-8")};this.controls=function(c){b.clear();a.title(c,a.menu)};this.fullscreen=function(){document.fullscreenElement?document.exitFullscreen&&document.exitFullscreen():document.documentElement.requestFullscreen()};this.prompt=function(){b.clear();b.print("specialstage.io","4","4",2);b.print("-","4","8",2)};this.challenge=function(c){b.clear();a.nav(function(){a.challenge()},a.menu);b.print("issue challenge url","2","2");b.print("-","2","4");b.style=2;b.print("issued by","2","6");b.style=0;b.print("> "+
ea,"2","9");b.style=2;b.print("[edit]",ea.length+"+9","9");b.button("","2","9+4p",ea.length+"+5","4",function(){a.inputName(a.challenge,!1)},!1);b.style=2;b.print("seed","2","13");b.style=5;b.print(N.name,"2","15");b.style=2;b.print("time","2","19");c=b["float"](G.CP()[3]+G.PENALTY());b.style=5;b.print(c,"2","21");b.style=0;b.button("copy challenge url","1","1.0-8","1.0-2","8",function(){b.clear();a.encodeURL();window.setTimeout(a.results,2E3)})};this.appearance=function(){b.clear();a.breadcrumb(this.vehicle,
this.state);a.nav(function(){a.appearance()},a.menu)};this.inputName=function(c,l,n){l=void 0===l?!1:l;n=void 0===n?"enter display name:":n;a.STATE=function(){a.inputName(c,l,n)};b.clear();ra=!0;l?a.nav(function(){c()},a.menu):a.title(c);b.print(n,"2","2");b.textinput(ea,"2","4","1.0-2","6","operator_id");var m=document.getElementById("operator_id");b.button("accept","2","14","1.0-4","6",function(){b.clear();b.print("submitting name to db","2","2");ea=vb(m.value.toLowerCase());!1===oa&&1<ea.length&&
null!==ea?firebase.auth().signInAnonymously().then(function(){oa=firebase.auth().currentUser.uid;a.submitName(oa,c,l);a.STATE=function(){}})["catch"](function(A){A.code;A.message}):!1!==oa&&1<ea.length&&null!==ea?a.submitName(oa,c,l):(b.clear(),b.print("invalid name","2","2"),window.setTimeout(a.STATE,1E3))},!0)};this.submitName=function(c,l,n){n=void 0===n?!1:n;1<ea.length&&10>ea.length?firebase.database().ref("uid/"+c).set({name:ea},function(m){m?(b.clear(),m="PERMISSION_DENIED"===m.code?"invalid name":
"network error",b.print(m,"2","2"),window.setTimeout(function(){a.inputName(l,n)},1E3)):(b.clear(),b.print("name change successful","2","2"),window.setTimeout(l,1E3))}):(b.clear(),b.print("invalid name","2","2"),window.setTimeout(function(){a.inputName(l,n)},1E3))};this.encodeURL=function(){for(var c="",l=N.name,n=0;n<l.length;n++){var m=l.charAt(n);m=" "===m?"-":m;c+=m}c=c+"/"+oa;window.history.pushState("","","/");l=window.location.href;var A="./#/"+c;navigator.clipboard.writeText(l+"/#/"+c).then(function(){b.print("url copied to clipboard",
"2","2");window.history.pushState("","",A)},function(){window.history.pushState("","",A);b.print("url copied to address bar","2","2")});firebase.analytics().logEvent("challenge_issued",{url:l+"#/"+c})};this.decodeURL=function(){for(var c=window.location.href,l="",n=[],m=!1,A=0,F=0;F<c.length;F++){var Q=c.charAt(F);m?"/"===Q?(Ja=!0,A++):(1===A&&(Q="-"===Q?" ":Q,l+=Q),1<A&&(n+=Q)):"#"===Q&&(m=!0,Sa=!0,A=0)}Ja&&0<n.length?(a.custom_seed=l,N.name=l,a.CHALLENGES={seed:l,uid:n}):Sa&&(a.custom_seed=l,N.name=
l,Ja=!1);firebase.analytics().logEvent("challenge_accepted",{url:c})};this.cSave=function(c,l){var n=new Date;n.setTime(n.getTime()+2808E7);n="expires="+n.toUTCString();document.cookie=c+"="+l+";"+n+";path=/"};this.cLoad=function(c){c+="=";for(var l=document.cookie.split(";"),n=0;n<l.length;n++){for(var m=l[n];" "==m.charAt(0);)m=m.substring(1);if(0==m.indexOf(c))return m.substring(c.length,m.length)}return""};this.checksave=function(){var c=a.cLoad("SAVE");if(0!==c.length&&null!=c){for(var l=0,n=
"",m="",A="",F="",Q=0,T=0;T<c.length;T++){var U=c.charAt(T);if("#"!==U)switch(Q){case 1:l=parseInt(U);break;case 2:n+=U;break;case 3:m+=c.charAt(T),A+=c.charAt(T+1),F+=c.charAt(T+2),T+=2}else Q++}G.MODEL=l;G.PAINT=n;G.paint();G.tune.power(parseInt(m));G.tune.drag(parseInt(A));G.tune.sensitivity(parseInt(F))}else G.PAINT=0,G.paint();if(c=a.cLoad("SETTINGS"),0!==c.length&&null!=c){l=0;m=n="";for(A=0;A<c.length;A++)if(F=c.charAt(A),"#"!==F)switch(l){case 0:n+=F;break;case 1:Ca=parseInt(F);break;case 2:m=
parseInt(F)}else l++;Ba=parseInt(n);Na=0!==m}};this.credit=function(){b.clear();b.print("procedural.ca","2","1.0-6");b.print("ginko.ltd","2","1.0-4")};this.promo=function(){b.clear();b.print("0.0.5","2","2");b.sprite(56,68,48,20,"2","6-4p",192,80,4);b.sprite(1,0,255,16,"2","20",255,16);b.print("https://specialstage.io","2","18");b.print("seed: ryuk mountain","2","1.0-10");b.print("best: ghxst90 (16.48)","2","1.0-8");b.print("data: ek9","2","1.0-6")};this.fpv=function(){b.clear();b.print("https://specialstage.io - 0.0.4",
"2","2");b.print("new feature","4","0.5");b.print("first person view (fpv)","4","0.5 + 4",2);window.setTimeout(function(){b.clear();b.print("https://specialstage.io - 0.0.4","2","2")},4E3)};this.biome=function(){b.clear();b.print("https://specialstage.io - 0.0.4","2","2");b.print("new feature","4","0.5");b.print("ice biome","4","0.5 + 4",2);window.setTimeout(function(){b.clear();b.print("https://specialstage.io - 0.0.4","2","2")},4E3)};this.physics=function(){b.clear();b.print("https://specialstage.io - 0.0.4",
"2","2");b.print("update","4","0.5");b.print("improved vehicle physics","4","0.5 + 4",2);window.setTimeout(function(){b.clear();b.print("https://specialstage.io - 0.0.4","2","2")},4E3)};this.endtag=function(){b.clear();b.print("play at","2","0.25-4");b.print("https://specialstage.io","2","0.25",1);b.print("challenges posted on discord","4","0.25+ 6");b.print("> discord.ginko.ltd","4","0.25 + 10");b.print("> discord.specialstage.io","4","0.25 + 12");window.setTimeout(a.music,2E3)};this.music=function(c){window.setTimeout(function(){b.print("procedural.ca",
"2","1.0-12")},500);window.setTimeout(function(){b.print("ginko.ltd","2","1.0-10")},1E3);window.setTimeout(function(){},3E3)};this.updates=function(){b.clear();b.print("https://specialstage.io - 0.0.4","2","2");b.print("updates","2","6");b.print("> added ice biome","2","10");b.print("> added fpv camera","2","12");b.print("> added snow particle effects","2","14");b.print("> added terrain drag penalty","2","16");b.print("> improved vehicle physics","2","18");b.print("> increased gravity","2","20");
b.print("> decreased air resistance","2","22");b.print("> disabled DNF timeout during button input for big jumps","2","24");b.print("> removed framerate dependecies","2","26");b.print("> reworked ui pixel scaling","2","28");window.setTimeout(function(){b.clear()},1E4)};this.plug=function(c){if("n"===c.key)switch(z){case 0:b.clear();window.setTimeout(a.promo,1E3);z++;break;case 1:window.setTimeout(a.biome,1E3);z++;G.CAMERA=4;break;case 2:window.setTimeout(a.physics,1E3);z++;G.CAMERA=2;break;case 3:window.setTimeout(a.fpv,
1E3);z++;G.CAMERA=3;break;case 4:window.setTimeout(a.endtag,1E3);z++;G.CAMERA=1;break;case 5:b.clear(),z=0}}}function wb(){var a=this;this.renderer=document.createElement("canvas");this.renderer.id="ui";document.body.appendChild(this.renderer);var e=this.renderer.getContext("2d");this.context=e;var g=document.createElement("img");g.src="./img/stage.font.0.0.4.png";g.onload=function(){a.connect();a.onload()};document.createElement("canvas");this.onload=function(){};var d=document.createElement("canvas"),
w=d.getContext("2d");this.scale=1;this.row=this.col=8;this.width;this.height;this.style=0;var z=128,x=180,t=128,r=80,c;var l=128;var n=x;var m=128;var A=80;var F=!(c={x:128,y:x+60,w:128,h:40}),Q=[],T=[],U=[];this.connect=function(){e.imageSmoothingEnabled=!1;a.format(0,"#ffffff")};this.format=function(p,C){p=void 0===p?0:p;C=void 0===C?"#ffffff":C;void 0===d[p]&&(d[p]=document.createElement("canvas"),w[p]=d[p].getContext("2d"));w[p].drawImage(g,0,0,128,128,0,0,128,128);w[p].globalCompositeOperation=
"source-atop";w[p].fillStyle=C;w[p].fillRect(0,0,128,128);w[p].globalCompositeOperation="source-out"};this.resize=function(p,C,E){a.scale=E;var D=window.devicePixelRatio,K=300>Math.ceil(D)/D*p?Math.floor(D):Math.ceil(D);0!=K-D&&(E=K/D);1>=D&&1<a.scale&&(E=a.scale);this.width=p/E;this.height=C/E;this.renderer.width=this.width;this.renderer.height=this.height;wa.setSize(this.width,this.height);a.scale=E;this.renderer.style.transform="scale("+E+","+E+")";wa.domElement.style.transform="scale("+E+","+
E+")";this.renderer.style.transformOrigin="top left";wa.domElement.style.transformOrigin="top left";e.imageSmoothingEnabled=!1;this.redraw();z=128;x=180;t=128;r=80;l=128;n=x;m=128;A=80;c={x:128,y:x+60,w:128,h:40};this.automate(this.width,this.height)};this.update=function(p){var C=0,E;for(E in p)for(var D in U)if(p[E].x>U[D].x*a.scale&&p[E].y>U[D].y*a.scale&&p[E].x<U[D].w*a.scale&&p[E].y<U[D].h*a.scale&&(C++,1==p[E].start)){U[D].funct();p[E].start=!1;break}};this.print=function(p,C,E,D){D=void 0===
D?1:D;for(var K=0,ca=a.compile(C,a.width,a.col),O=a.compile(E,a.height,a.row);K<p.length;)a.encode(p.charAt(K),ca+K*a.col*D,O,D),K++;F||Q.push(function(){a.print(p,C,E,D)})};this.text=function(p,C,E,D,K){D=void 0===D?1:D;for(K=0;K<p.length;)a.encode(p.charAt(K),C+K*a.col*D,E,D),K++};this.button=function(p,C,E,D,K,ca,O,M){O=void 0===O?!0:O;M=void 0===M?1:M;var Y=a.compile(C,a.width,a.col),ka=a.compile(E,a.height,a.row),ha=a.compile(D,a.width,a.col),la=a.compile(K,a.height,a.row);O&&(e.drawImage(d[a.style],
0,0,1,1,Y,ka+la/2,ha+1,1),e.drawImage(d[a.style],0,0,1,1,Y,ka-la/2,ha+1,1),e.drawImage(d[a.style],0,0,1,1,Y,ka-la/2,1,la),e.drawImage(d[a.style],0,0,1,1,Y+ha-1,ka-la/2,1,la));for(var ba=0;ba<p.length;)a.encode(p.charAt(ba),Y+ba*a.col+ha/2-Math.round(p.length*a.col)/2+2,ka-a.row/2,M),ba++;U.push({x:Y,y:ka-la/2,w:Y+ha,h:ka+la/2,funct:function(){ca()}});F||Q.push(function(){a.button(p,C,E,D,K,ca,O,M)})};this.line=function(p,C,E,D){a.sprite(0,0,1,1,p,C,E,D)};this.sprite=function(p,C,E,D,K,ca,O,M){var Y=
a.compile(K,a.width,a.col),ka=a.compile(ca,a.height,a.row),ha=a.compile(O,a.width,a.col),la=a.compile(M,a.height,a.row);e.drawImage(d[a.style],p,C,E,D,Y,ka,ha,la);F||Q.push(function(){a.sprite(p,C,E,D,K,ca,O,M)})};this.backdrop=function(p,C,E,D,K){p=void 0===p?"#10101099":p;!1===p?(a.clear(),a.renderer.style.background="transparent"):(a.clear(),a.renderer.style.background=p)};this.getDrawList=function(){return Q};this.redraw=function(){F=!0;a.clear();for(var p=0;p<Q.length;p++)Q[p]();p=document.body.getElementsByTagName("input");
for(var C=0;C<p.length;C++)a.text(p[C].value,p[C].style.top,p[C].style.left);F=!1};this.automate=function(p,C){p=Math.floor(p/3)-2;C=Math.floor(C/4);t>p&&(t=p,z=p,m=p,l=p,c.w=p,c.x=p);x>C&&(x=C+40,n=x,c.y=x+60)};this.pad=function(p,C,E,D,K,ca,O){var M=0;for(O();M<fa.touches.length;)fa.touches[M].x>C*a.scale&&fa.touches[M].y>E*a.scale&&fa.touches[M].x<(C+D)*a.scale&&fa.touches[M].y<(E+K)*a.scale&&ca(),M++;Na&&(e.drawImage(d[a.style],0,0,1,1,C+1,E,D-1,1),e.drawImage(d[a.style],0,0,1,1,C+1,E+K,D-1,1),
e.drawImage(d[a.style],0,0,1,1,C+1,E,1,K),e.drawImage(d[a.style],0,0,1,1,C+D-1,E,1,K));a.encode(p,C+D/2-a.col/2,E+K/2-a.row/2)};this.dpad=function(){e.drawImage(d[a.style],88,88,40,40,a.width-l+m/2-20,a.height-n+A/2-20,40,40);a.pad("<",z-t-1,a.height-x,t,r,function(){fa.LEFT=!0},function(){fa.LEFT=!1});a.pad(">",z+1,a.height-x,t,r,function(){fa.RIGHT=!0},function(){fa.RIGHT=!1});a.pad("^",a.width-l,a.height-n,m,A,function(){fa.UP=!0},function(){fa.UP=!1});a.pad("b",a.width-c.x,a.height-c.y+c.h/2,
c.w,c.h,function(){fa.DOWN=!0},function(){fa.DOWN=!1})};this.clear=function(){if(!F){for(var p=document.body.getElementsByTagName("input"),C=0;C<p.length;C++)document.body.removeChild(p[C]);if(!a.REDRAW){Q=[];for(p=0;p<T.length;p++)document.body.removeChild(T[p]);T=[]}Q=[]}U=[];e.clearRect(0,0,a.width,a.height)};this["delete"]=function(p,C,E,D){C=void 0===C?0:C;E=void 0===E?wa.width:E;D=void 0===D?wa.height:D;p=a.compile(void 0===p?0:p,a.width,a.col);C=a.compile(C,a.height,a.row);E=a.compile(E,a.width,
a.col);D=a.compile(D,a.height,a.row);e.clearRect(p,C,E,D)};this.encode=function(p,C,E,D){D=void 0===D?1:D;var K=p.charCodeAt(0);p=8*K%128;K=8*Math.floor(K/16);e.clearRect(C,E,8,8);e.drawImage(d[a.style],p,K,8,8,C,E,8*D,8*D)};this["float"]=function(p,C){var E=Math.floor(Math.abs(100*p));E=E.toString();var D=E.slice(0,E.length-2),K=E.slice(E.length-2,E.length);return 0==p?"0.00":(0==D.length&&(D="0"),2>K.length&&(K+="0"),C&&0<p?D="+"+D:0>p&&(D="-"+D),E=D+"."+K,E)};this.compile=function(p,C,E){var D=
0;switch(C=Math.floor(C),typeof p){case "number":D=p;break;case "function":D=p();break;case "string":for(var K=!1,ca=1,O=0,M="";O<p.length;){var Y=p.charAt(O);"."===Y?(M+=Y,K=!0):"+"===Y?(M=K?Number(M)*C:Number(M)*E,M*=ca,ca=1,D+=M,K=!1,M=""):"-"===Y?(M=K?Number(M)*C:Number(M)*E,M*=ca,ca=-1,D+=M,K=!1,M=""):"p"===Y?(M=Number(M),M*=ca,D+=M,M=""):O===p.length-1?(M+=Y,M=K?Number(M)*C:Number(M)*E,M*=ca,D+=M,M=""):M+=Y;O++}}return D};this.textinput=function(p,C,E,D,K,ca,O){var M=a.compile(C,a.width,a.col),
Y=a.compile(E,a.height,a.row),ka=a.compile(D,a.width,a.col),ha=a.compile(K,a.height,a.row);if(F)a.text("> "+O.value,M,Y+ha/2);else{(O=document.createElement("input")).type="text";O.id=ca;O.name=ca;O.value=p;O.style.top=Y*a.scale+"px";O.style.left=M*a.scale+"px";O.style.width=ka*a.scale+"px";O.style.height=ha*a.scale+"px";O.style.paddingLeft=12*a.scale+"px";O.style.fontSize=14*a.scale+"px";O.maxlength=10;O.autofocus=!0;a.text("> "+O.value,M,Y+ha/2);document.body.appendChild(O);window.setTimeout(function(){O.focus();
O.select()},200);O.oninput=function(){la()};O.onfocusout=function(){la()};O.onfocusin=function(){la()};O.onclick=function(){la()};var la=function(ba){a["delete"](M,Y,ka,ha);a.text("> "+O.value,M,Y+ha/2);a.text("_",O.selectionStart*a.col+2*a.col+M,Y+ha/2)};Q.push(function(){a.textinput(O.value,C,E,D,K,ca,O)})}};this.link=function(p,C,E,D,K,ca,O,M){var Y=a.compile(C,a.width,a.col)*a.scale,ka=a.compile(E,a.height,a.row)*a.scale,ha=a.compile(D,a.width,a.col)*a.scale,la=a.compile(K,a.height,a.row)*a.scale;
F||Q.push(function(){return new function(){ba.style.left=Y+"px";ba.style.top=ka+"px";ba.style.width=ha+"px";ba.style.height=la+"px";a.print(p,Y,ka)}});var ba=document.createElement("a");ba.href=ca;ba.style.left=Y+"px";ba.style.top=ka+"px";ba.style.width=ha+"px";ba.style.height=la+"px";ba.style.display="block";ba.style.zIndex=400;ba.style.position="fixed";ba.target="_blank";ba.id=ca;document.body.appendChild(ba);T.push(ba);F=!0;a.print(p,Y,ka);F=!1}}function xb(){function a(){if(r)for(var J=0;1>J;){ja.geometry.vertices[Aa].copy(t.direction);
ja.geometry.vertices[Aa].multiplyScalar(-1-Math.random()*La);ja.geometry.vertices[Aa].add(t.position);ja.geometry.vertices[Aa].life=ja.geometry.vertices[Aa].maxLife;Math.random();Math.random();Math.random();var ta=.1*-Math.random();ja.geometry.vertices[Aa].acc.copy(t.direction);ja.geometry.vertices[Aa].acc.multiplyScalar(ta);Aa++;Aa%=ja.geometry.vertices.length;J++}for(var sa in ja.geometry.vertices)0<ja.geometry.vertices[sa].life&&(ja.geometry.vertices[sa].add(ja.geometry.vertices[sa].acc),--ja.geometry.vertices[sa].life,
ja.geometry.colors[sa].setHSL(0,0,ja.geometry.vertices[sa].life/100)),0>=ja.geometry.vertices[sa].life&&(ja.geometry.vertices[sa].set(0,0,0),ja.geometry.vertices[Aa].acc.x=0,ja.geometry.vertices[Aa].acc.y=0,ja.geometry.vertices[Aa].acc.z=0);ja.geometry.verticesNeedUpdate=!0;ja.geometry.colorsNeedUpdate=!0;ja.geometry.computeBoundingSphere()}var e=this;this.TEXTTIME=this.SPEED="";this.END=this.START=!1;this.OBJECTIVE=0;this.POSITION;this.MODEL=1;this.ANALOG=!1;this.PENALTY=function(){return T};this.CAMERA=
1;this.FPV=!1;var g=[],d=0,w=1/60*1E3,z=1,x=new THREE.Mesh(new THREE.IcosahedronGeometry(4,0),new THREE.MeshBasicMaterial({wireframe:!0})),t={position:new THREE.Vector3,normal:new THREE.Vector3,direction:new THREE.Vector3,rotation:0},r=!1,c=!1,l=!0,n=!1,m=1,A=0,F=[],Q=0,T=0,U=0,p=0,C=!1,E=!1,D=!1,K=0,ca=0,O=0;this.DT=function(){return 1};var M={power:3,drag:1,mass:1,brake:3,sensitivity:2,ease:0},Y=0,ka=0,ha=0;Y=.004;ka=.985-.98;ha=.015;var la,ba,Ha,Ia=6,La,k=0,h=0,f=0,y=new THREE.Vector3(0,1,0),u=
new THREE.Vector3(0,0,0),q=new THREE.Vector3,S=new THREE.Vector3(0,5,0);new THREE.Vector3(1,0,0);var B=new THREE.Vector3(0,0,1),I=new THREE.Vector3(0,0,1),H=new THREE.Vector3(0,0,1),P=new THREE.Vector3(0,0,1),Z=new THREE.Vector3(0,0,-.008),V=new THREE.Vector3,ua=new THREE.Vector3,za=new THREE.Vector3,va=new THREE.Vector3,Ea=[],Ka=new THREE.Vector3(0,0,1),Pa=new THREE.Raycaster(va,Ka,0,2);this.cameras=[];this.cameras[0]={distance:22,x:0,y:0,z:9,lerp:.1,lookAt:new THREE.Vector3};this.cameras[1]={distance:0,
...
ma=(new THREE.LineSegments(Qa[e.MODEL].geometry(),Wa)).clone();ma.name="Vehicle";for(var Aa=0,Xa=new THREE.Geometry;100>Xa.vertices.length;){var Ra=new THREE.Vector3(0,0,0);Ra.life=0;Ra.maxLife=100;Ra.acc=new THREE.Vector3(0,0,0);Xa.vertices.push(Ra);Ra=new THREE.Color(4294967040);Xa.colors.push(Ra)}Xa.verticesNeedUpdate=!0;var ja=new THREE.Points(Xa,new THREE.PointsMaterial({size:.1,vertexColors:THREE.VertexColors,blending:THREE.AdditiveBlending,transparent:!0}));ja.name="Emitter";this.init=function(){};
this.connect=function(J,ta){ma.copy(new THREE.LineSegments(Qa[e.MODEL].geometry(),Wa));ma.name="Vehicle";ma.geometry.computeBoundingSphere();za.copy(J);V.copy(za);ma.position.copy(za);ua.copy(V);aa.add(ma);aa.add(ja);e.tune.power();e.tune.drag();e.tune.sensitivity();e.tune.ease();aa.fog=new THREE.FogExp2(X[0],.005);W.fov=90;W.updateProjectionMatrix();aa.add(N.generate.stars);n=!1;window.setTimeout(function(){n=!0},1E3);N.SNOW&&aa.add(N.snow.mesh);g=[];d=0;p=Da;g[0]={position:V.clone(),normal:new THREE.Vector3(0,
0,1),direction:new THREE.Vector3(0,1,0),camera:new THREE.Vector3,rotation:0,velocity:new THREE.Vector3,time:Da};ia.reset()};this.disconnect=function(){e.reset();aa.remove(ma);aa.remove(ja);aa.fog=new THREE.FogExp2(X[0],0);aa.remove(N.generate.stars)};this.ready=function(){r&&(ia.reset(),p=window.performance.now(),A=0,e.START=!0)};this.reset=function(){if(e.END&&F[3]+T<N.best[3])for(var J in N.best)N.best[J]=3===J?A+T:F[J];n=Ma=this.END=this.START=!1;fa.UP=!1;fa.DOWN=!1;fa.LEFT=!1;R=L=c=r=fa.RIGHT=
!1;A=0;F=[];O=U=T=K=0;V.copy(za);ua.copy(V);y.set(0,1,0);q.set(0,0,0);P.set(0,0,1);ma.copy(new THREE.LineSegments(Qa[e.MODEL].geometry(),Wa));ma.lookAt(P);k=h=0;W.position.copy(V);W.position.add(y.clone().multiplyScalar(-60));W.position.z+=40;W.up.set(0,0,1);W.lookAt(ma.position);W.updateProjectionMatrix();wa.render(aa,W);da.reset();window.setTimeout(function(){n=!0},1E3);for(J=0;J<pa.length;J++)pa[J].reset();ia.reset();g=[];d=0;p=Da;g[0]={time:Da,position:V.clone(),normal:P.clone(),direction:new THREE.Vector3(0,
1,0),camera:W.position.clone(),velocity:new THREE.Vector3,rotation:0}};this.update=function(){R=Ma||e.END||!n?(r=!1,c=!1,L=!1):(r=fa.UP,c=fa.DOWN,L=fa.LEFT,fa.RIGHT);var J=0;if(Da>g[d].time){var ta={};Object.assign(ta,g[d]);var sa=ta.time;g=[];d=0;g.push({time:sa,position:ta.position.clone(),normal:ta.normal.clone(),direction:ta.direction.clone(),velocity:ta.velocity.clone(),rotation:ta.rotation,camera:ta.camera.clone()});for(var Fa=window.performance.now();sa<Fa;){sa+=w;g.push({time:sa,position:g[d].position.clone(),
normal:g[d].normal.clone(),direction:g[d].direction.clone(),velocity:g[d].velocity.clone(),camera:ta.camera.clone(),rotation:g[d].rotation});d=g.length-1;var mb=Fa=void 0;0!=(mb=L&&R?0:L?1:R?-1:0)&&Math.abs(f)<Ia?f+=mb:Math.abs(f)>Ia?(Fa=f/Math.abs(f),f=Ia*Fa):0<Math.abs(f)&&(Fa=f/Math.abs(f),f-=f/Math.abs(f),f/Math.abs(f)!=Fa&&(f=0));k=f/Ia*Ha;g[d].rotation+=k;La=g[d].velocity.length();Fa=void 0;r&&l&&(u.copy(g[d].direction),u.multiplyScalar(la),g[d].velocity.add(u));c&&l&&g[d].velocity.multiplyScalar(.95);
l?(D=!1,Fa=E?ba-.01:ba,g[d].velocity.multiplyScalar(Fa)):l||(D?g[d].velocity.add(Z):D=!0,g[d].velocity.multiplyScalar(.998));g[d].position.add(g[d].velocity);x.position.copy(g[d].position);va.copy(g[d].position);va.z-=50;Ea=[];Ka.set(0,0,1);Pa.far=100;Pa.set(va,Ka);N.surface.raycast(Pa,Ea);0<Ea.length?(va.copy(Ea[0].point),E=g[d].position.z<va.z&&5>Math.abs(g[d].position.z-va.z)?(Q=0,l=!0,I.copy(Ea[0].face.normal),g[d].position.copy(va),1!==Ea[0].face.color.r):l=!1):0===Ea.length&&(l=!1,E=!1,r||c||
L||R||(Q+=w),1E3<Q&&!e.END&&!Ma&&(Ma=!0,na.dnf()));I.clone().multiplyScalar(1);H.lerp(I,D?.001:.25);P.copy(H);P.add(g[d].position);g[d].normal=H.clone();x.lookAt(P);x.rotateOnAxis(B,g[d].rotation);y.copy(x.localToWorld(S.clone()));y.sub(g[d].position);y.normalize();g[d].direction.copy(y);(function(){Ea=[];Ka.copy(g[d].position);Ka.sub(g[d-1].position);Ka.normalize();Pa.far=Ka.length();Pa.set(g[d].position,Ka);for(var ya=0,qa=!1,bb=O;5>bb;bb++)if(N.generate.checkpoints[bb].collision.raycast(Pa,Ea),
0<Ea.length){ya=bb;qa=!0;break}if(C=!1,qa){var xa;qa=Math.floor(100*A)/100;if(ya===O)N.generate.checkpoints[O].display.material.color=X[4],0<O&&(F[O-1]=qa,b["delete"](16,32,b.width-16,16),xa=Number.isNaN(N.best[O-1])?"+1 cp":qa-N.best[O-1],b.style=0<xa?4:0>xa?1:2,xa=0<xa?"(-"+b["float"](xa)+")":"+1 cp"===xa?"+1 cp":"(+"+b["float"](Math.abs(xa))+")",b.text(xa,16,32),b.style=0),4===O&&(C=!0,F[ya-1]=qa,F[ya]=qa+T,K=A+T<N.best[3]?100-T+Math.floor(10*(N.best[3]-(qa+T))):100-T,ca+=K,e.END=!0,fa.RESET=!1,
na.complete()),C=!0,O++;else{C=!0;for(xa=O-1;xa<ya-1;xa++)0<=xa&&(F[xa]="-",U++);T=25*U;4===ya?(F[ya-1]=qa,F[ya]=qa+T,K=A+T<N.best[3]?100-T+Math.floor(10*(N.best[3]-(A+T))):100-T,ca+=K,O=0,e.END=!0,fa.RESET=!1,na.complete()):(F[ya-1]=qa,O=ya+1,b["delete"]("2","4","30","1"),b.style=2,b.text("missed checkpoint x "+U.toString()+" ( -"+T.toString()+".00 )",16,32),b.style=0);C=!0;N.generate.checkpoints[ya].display.material.color=X[4]}}e.SPEED=Math.round(60*La/1E3*3600);e.START&&!e.END&&(A=(Da-p)/1E3);
e.OBJECTIVE=O;ua.copy(V)})();J++;e.START&&da.record(e);x.updateMatrix();Fa=window.performance.now()}}if(z=(w-(g[d].time-Da))/w,1<z&&(z=1),1<g.length)t.position.copy(g[d-1].position),t.position.lerp(g[d].position,z),t.normal.copy(g[d-1].normal),t.normal.lerp(g[d].normal,z),t.normal.multiplyScalar(5),J=t.normal.clone(),J.add(t.position),t.rotation=g[d].rotation,t.rotation-=g[d-1].rotation,t.rotation=g[d-1].rotation+t.rotation*z,t.direction.copy(g[d-1].direction),t.direction.lerp(g[d].direction,z),t.direction.multiplyScalar(5),
t.direction.normalize(),ma.position.copy(t.position),ma.lookAt(J),ma.rotateOnAxis(B,t.rotation),function(){if(e.FPV)e.fpv();else{var ya=Ma||e.END?1E-5:.1,qa=t.direction.clone();qa.multiplyScalar(-e.cameras[0].distance+4*(b.scale-1));qa.add(t.position);qa.z+=e.cameras[0].z;W.position.lerp(qa,ya);W.lookAt(ma.position)}}(),a();this.START||this.ready()};this.results=function(){return{reward:K,yen:ca}};this.AT=function(){return A};this.CP=function(){return F.slice()};this.replay=function(J){J={TS:ia.time};
da.frame=da.convert(da.tape,J,da.frame);t.position.copy(J.position);H.copy(J.lookTarget);t.rotation=J.rotation;t.normal.copy(H);t.normal.add(t.position);ma.position.copy(t.position);ma.lookAt(t.normal);ma.rotateOnAxis(B,t.rotation);t.direction.copy(ma.localToWorld(S.clone()));t.direction.sub(t.position);t.direction.normalize();r=J.UP;C=J.CHECK;t.rotation=J.rotation;O=J.objective;J=t.position.clone();if(C&&(N.generate.checkpoints[O].display.material.color=X[4]),3===e.CAMERA)e.fpv();else{var ta=1,sa=
1;e.CAMERA===m&&(ta=e.cameras[1].lerp,sa=1);m=e.CAMERA;J.x+=e.cameras[e.CAMERA].x;J.y+=e.cameras[e.CAMERA].y;J.z+=e.cameras[e.CAMERA].z;W.up.set(0,0,1);W.position.lerp(J,ta);e.cameras[m].lookAt.lerp(t.position,sa);W.lookAt(e.cameras[m].lookAt)}a()};this.record=function(){return{position:g[d].position.clone(),lookTarget:g[d].normal.clone(),UP:r,AT:A,TS:da.tape.length*w,rotation:g[d].rotation,objective:O,check:C}};this.fpv=function(){W.position.copy(t.position);var J=ma.localToWorld(new THREE.Vector3(0,
0,5));J.sub(t.position);J.normalize();W.up.copy(J);J=t.direction.clone();J.add(t.position);W.lookAt(J)};this.tune={power:function(J){J=void 0===J?M.power:J;M.power=0>J?0:5<J?5:J;la=.016+M.power/5*Y},drag:function(J){J=void 0===J?M.drag:J;M.drag=0>J?0:5<J?5:J;ba=.985-M.drag/5*ka},sensitivity:function(J){J=void 0===J?M.sensitivity:J;M.sensitivity=0>J?0:5<J?5:J;Ha=.06+M.sensitivity/5*ha},ease:function(J){J=void 0===J?M.ease:J;M.ease=0>J?0:5<J?5:J;Ia=6+M.ease}};this.param=function(){return array=Object.assign(M,
[]),array.model=Qa[e.MODEL].name,array};this.paint=function(J){J=void 0===J?e.PAINT:J;e.PAINT=J;Wa.color.set(Va[J]);Wa.needsUpdate=!0};this.body=function(){ma.geometry.dispose();ma.geometry=Qa[e.MODEL].geometry().clone();ma.geometry.verticesNeedUpdate=!0};this.yen=function(){return na.cSave("YEN",ca),ca};this.debug=function(){console.log("position:",ma.position,V);console.log("direction:",y);console.log("rotation:",h);console.log("dt:",1);console.log("TIME:",Da);console.log("TAPES:",Math.ceil(Da-
...
objective:d.getObjective(),check:d.check,UP:d.UP}};this.record=function(d){e.tape[g]=d.record();g=24E4<e.tape[g].TS?0:g+1};this.play=function(d){if(this.RECORD){this.RECORD=!1;for(var w=e.frame=0;w<pa.length;w++)pa[w].reset();ia.reset()}if(e.frame>e.tape.length-10){e.frame=0;ia.reset();for(w=0;w<pa.length;w++)pa[w].reset();N.generate.resetCheckpoints()}if(d.replay(),this.tape[e.frame].check)N.generate.checkpoints[0===this.tape[e.frame].objective?4:this.tape[e.frame].objective-1].display.material.color=
X[4]};this.reset=function(){N.generate.resetCheckpoints();g=0;e.frame=0;ia.reset();e.PLAY=!1;e.RECORD=!0;e.tape=[]};this["export"]=function(d){d=void 0===d?function(){na.results()}:d;if((!1===Ua||G.CP()[4]<Ua&&!e.SCAN)&&""!==ea&&null!==ea&&!1!==oa&&void 0!==oa){b.print("uploading vhs to db","2","2");Ua=G.CP()[4];oa;for(var w=N.name,z=G.CP()[4],x=G.CP().slice(),t=G.MODEL,r=G.PAINT,c=e.save(e.tape),l=[],n=0;n<c.length;n++){var m="";m+=e.burn(c[n].TS);m+="#";m+=e.burn(Math.round(100*c[n].AT)/100);m+=
"#";m+=e.burn(c[n].position.x);m+="#";m+=e.burn(c[n].position.y);m+="#";m+=e.burn(c[n].position.z);m+="#";m+=e.burn(c[n].lookTarget.x);m+="#";m+=e.burn(c[n].lookTarget.y);m+="#";m+=e.burn(c[n].lookTarget.z);m+="#";m+=e.burn(c[n].rotation);l.push(m)}r={version:"005",id:oa,seed:w,time:Math.round(100*z)/100,cp:x,data:l,model:t,paint:r};firebase.database().ref("vhs/005/"+r.seed+"/"+oa).set(r,function(A){A?(b.clear(),b.print("network error","2","2")):(b.clear(),b.print("vhs succesfully submitted","2",
"2"));window.setTimeout(d,1E3)})}else void 0===oa||!1===oa||null===ea||""===ea||void 0===ea?na.register():na.results()};this.burn=function(d){return Math.round(1E9*d).toString(16)};this.read=function(d){return parseInt(d,16)/1E9};this.scan=function(d,w){e.SCAN=!0;var z=[];firebase.database().ref("vhs/005/"+d).orderByChild("time").limitToFirst(99).once("value").then(function(x){x.forEach(function(t){var r=t.child("id").val();t=t.child("time").val();z.push({uid:r,time:t})});e.SCAN=!1;w(z)})};this.checkTime=
...
T=new THREE.LineSegments(F,Q);T.name="ghost_"+pa.length;T.position.copy(z[0].position);aa.add(T);x=0;cp=d.slice();(cp[4]<N.best[4]||null==N.best[4])&&(N.best=cp.slice());this.reset=function(){ia.reset();x=0;w.update()};this.update=function(){var U={TS:ia.time};x=da.convert(z,U,x);r.copy(U.position);l.copy(U.lookTarget);A=U.rotation;n.copy(l);n.add(r);T.position.copy(r);T.lookAt(n);T.rotateOnAxis(t,A);c.copy(T.localToWorld(m.clone()));c.sub(r);c.normalize();w.position.copy(r);w.direction.copy(c);w.frame=
x};this.disconnect=function(){aa.remove(T);F.dispose();Q.dispose()}};window.onload=function(){window.addEventListener("touchstart",kb);window.addEventListener("contextmenu",function(){event.preventDefault()});aa=new THREE.Scene;aa.background=nb;ob=new THREE.Vector3(0,0,1);W=new THREE.PerspectiveCamera;W.up=ob;W.position.z=2E3;W.lookAt(0,0,0);W.fov=70;W.near=1E-4;W.far=3E3;W.name="Camera";aa.add(W);wa=new THREE.WebGLRenderer({logarithmicDepthBuffer:!0,antialias:!1,precision:"highp"});wa.setClearColor(nb);
wa.domElement.id="renderer";wa.setSize(document.innerWidth,document.innerHeight);document.body.appendChild(wa.domElement);fa=new pb;fa.connect();b=new wb;N=new rb;G=new xb;da=new yb;na=new tb;na.login();na.checksave();na.decodeURL();G.init();b.onload=function(){b.format(1,"#50ffae");b.format(2,"#999999");b.format(3,"#75e8ff");b.format(4,"#ff7272");b.format(5,"#eeeeee");W.position.set(0,25,10);W.lookAt(0,0,0);Za();lb();na.intro()}};window.onresize=Za;window.fullscreenchange=Za;window.focus=Za;var Ya=
...
X=[1052688,16777215,12698049,2894892,5308334,16740978,2393855,2201343,3424820,2201152,7168071,10066329,16756970],hb;for(hb in X){var zb=new THREE.Color(X[hb]);X[hb]=zb}var Va=[16777215,16760825,12910564,16758197,16383882,14267903,7727359],ub="snow sakura melon peach bumblebee lavender ice".split(" "),Ua=!1,Sa="",Oa=Math.floor(2147483647*Math.random()),jb="",aa,W,wa,N,G,fa,b,da,na,pa=[],Ba=12,$a=9,Ca=0,fb=!1,oa=null,ea="",ob,Ga=!1,nb=X[0],sb=0,Ma=!1,Ta=!1,ra=!1,db=!1,Ja=!1,Na=!0,Da=0,cb=!1;firebase.initializeApp({apiKey:"AIzaSyB8RCC02kiLKX3Vm5bUCKDdYgKKVyMRh_0",
